...
```
    ...
    current_rapid_insulin = see below
...
- Amount of current level of rapid insulin is calculated from the properties of given rapid insuline type that we take from:
